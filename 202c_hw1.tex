     ...
     \part Consider (only in this question) that country 2's productivity increases by a factor of 2, from $A_2 = 0.6$ to $A_2' = 1.2$, while the others remain unchanged.
        ...
        \part     $$ T = \begin{pmatrix}
          ...
          \begin{enumerate}
            ...
            \begin{solution} 
                $\frac{w_2}{w_1} = 2.0182 \frac{w_3}{w_1} =1.2255 \frac{w_4}{w_1} = 1.239$
                
            \end{solution}
            \item Solve for bilateral trade shares, $\lambda_{ij}$ for $i = 1, 2, 3, 4$ and $j = 1, 2, 3, 4$
            \begin{solution}
                $$\lambda = \begin{pmatrix}
                0.4652 & 0.2578 & 0.2197 & 0.226 \\
                0.2284 & 0.5064 & 0.2158 & 0.2219 \\
                0.1549 & 0.1192 & 0.4213 & 0.1282 \\
                0.1515 & 0.1166 & 0.1431 & 0.4239 \\
                \end{pmatrix}
                $$
              \end{solution}
          \end{enumerate}
